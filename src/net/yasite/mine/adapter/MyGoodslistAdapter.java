package net.yasite.mine.adapter;
...
public class MyGoodslistAdapter extends YasiteAdapter {
	...
	public MyGoodslistAdapter(Context context, List<MyGoodsEntity> list) {
		super(context);
		setImageLoader();
	}
	...
	protected void setupChildViews(View convertView, ViewHolder holder) {
		...
		h.imageView = (ImageView) convertView
				.findViewById(R.id.my_activity_goodslist_item_image);
		h.textView1 = (TextView) convertView
				.findViewById(R.id.my_activity_goodslist_item_goodsname);
		h.textView2 = (TextView) convertView
				.findViewById(R.id.my_activity_goodslist_item_market_price);
		h.textView3 = (TextView) convertView
				.findViewById(R.id.my_activity_goodslist_item_shop_price);
	...
	protected void setLayoutResource(int position) {
		// TODO Auto-generated method stub
		layoutId = R.layout.my_activity_goodslist_item;
	}
